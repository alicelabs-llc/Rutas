...
const Settings: React.FC<SettingsProps> = ({ config, onUpdate }) => {
  ...
  // SECURITY FIX: Validate language exists in translations, fallback to 'en' if not
  const t = translations[localConfig.language] || translations['en'];
